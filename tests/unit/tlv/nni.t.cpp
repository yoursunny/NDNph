...
TEST(NNI, Decode)
{
  std::vector<uint8_t> wire({
    ...
    0xC3, 0x03, 0xA0, 0xA1,
    0xA2, // C3
    0xC4, 0x04, 0xA0, 0xA1, 0xA2,
    0xA3, // C4
    0xC5, 0x05, 0xA0, 0xA1, 0xA2, 0xA3,
    0xA4, // C5
    0xC6, 0x06, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4,
    0xA5, // C6
    0xC7, 0x07, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5,
    0xA6, // C7
    0xC8, 0x08, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5, 0xA6,
    0xA7, // C8
    0xC9, 0x09, 0xA0, 0xA1, 0xA2, 0xA3, 0xA4, 0xA5, 0xA6, 0xA7,
    0xA8, // C9
  });
...
TEST(NNI, Encode)
{
  ...
  EXPECT_THAT(std::vector<uint8_t>(encoder.begin(), encoder.end()),
              T::ElementsAre(0xC3, 0x08, 0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6,
                             0xB7, // C3
