...
# generate CA key
CACERT=$(ndnts-keychain gen-key /authority)

# make CA profile
ndnts-keychain ndncert03-make-profile --out /tmp/ca.data --prefix /authority --cert $CACERT --valid-days 60

# start CA with "nop" challenge
ndnts-keychain ndncert03-ca --profile /tmp/ca.data --store /tmp/ca-repo --challenge nop
...
ndnts-keychain ndncert03-ca --profile /tmp/ca.data --store /tmp/ca-repo --challenge possession
